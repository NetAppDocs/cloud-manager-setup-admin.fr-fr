...
Cette page explique comment créer un connecteur dans AWS directement à partir de BlueXP. link:concept-connectors.html#how-to-create-a-connector["Découvrez d'autres méthodes de déploiement d'un connecteur"].
